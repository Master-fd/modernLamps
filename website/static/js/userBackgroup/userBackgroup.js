...
define(function(require, exports){
    ...
    switch (pageId){
        case 'myAddress' : $body.find('.user-page-left .js-address').addClass('current');break;
        case 'myOrder' : $body.find('.user-page-left .js-order').addClass('current');break;
        case 'myCollect' : $body.find('.user-page-left .js-collect').addClass('current');break;
        case 'myPersonal' : $body.find('.user-page-left .js-userInfo').addClass('current');break;
        default : $body.find('.user-page-left .js-address').addClass('current');break;
    }
