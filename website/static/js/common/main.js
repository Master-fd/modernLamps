...
define(function(require){
    ...
    switch (_page){
        ...
        //manager后台
        case 'allGoods' : seajs.use('static/js/managerBackgroup/managerBackgroup.js');
                            seajs.use('static/js/managerBackgroup/allGoods.js'); break;
        case 'allOrder' : seajs.use('static/js/managerBackgroup/managerBackgroup.js');
                            seajs.use('static/js/managerBackgroup/allOrder.js');break;
        case 'uploadGoods' : seajs.use('static/js/managerBackgroup/managerBackgroup.js');
